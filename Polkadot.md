...
<img src = "https://github.com/sapsssay/POLKADOT/blob/main/Screenshot%202022-10-20%20at%2012.56.24.png" width="450" height="420">
Put up for auction:
https://drive.google.com/file/d/1UVU9X4YAAld84sbFig7G75j9Jbq2p_kX/view?usp=sharing

<img src = "https://github.com/sapsssay/POLKADOT/blob/main/Screenshot%202022-10-20%20at%2012.55.19.png" width="300" height="475">
...
| Description                                                                                                                         | Duration                                                                                                                                                                                                              |
|-------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Creation   of NFT GAME API architecture and documentation                                                                           | 14 days                                                                                                                                                                                                               |
...
| Description                                                                              | Duration                                                                                                                                                                                                                                         |
|------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Creation   of architecture and documentation for game modules UNITY 3D and Unreal engine | 10 days                                                                                                                                                                                                                                          |
