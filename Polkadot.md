...
|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---|
| 1         | Analytics   and connection parsing transactions Polkadot / Moonbeam                                                                                                                                | 21                                                                                                                                                                                                                                                                                                              |   |
|           | Development   and publication of NFT and EVM smart contracts on the blockchain. Integration   of RPC methods for working with smart contracts. Connecting RPC Methods to   the Getcrystal Platform | 14                                                                                                                                                                                                                                                                                                              |   |
|           | Connecting   a WEB3 wallet and IPFS for NFT storage                                                                                                                                                | 7                                                                                                                                                                                                                                                                                                               |   |
|           | Create   an account and publish NFT and NFT collections                                                                                                                                            | 7                                                                                                                                                                                                                                                                                                               |   |
|           | NFT   Placement Testing, Selling, Transferring, Buying and Auctioning                                                                                                                              | 7                                                                                                                                                                                                                                                                                                               |   |
...
| 2         | Creation   of NFT GAME API architecture and documentation                                                                                                                                          | 14                                                                                                                                                                                                                                                                                                              |   |
|           | Development   of the NFT API, connection of methods for transmitting information about the   owner of the NFT and its characteristics                                                              | 7                                                                                                                                                                                                                                                                                                               |   |
|           | Testing   the API                                                                                                                                                                                  | 4                                                                                                                                                                                                                                                                                                               |   |
...
| 3         | Creation   of architecture and documentation for game modules UNITY 3D and Unreal engine                                                                                                           | 10                                                                                                                                                                                                                                                                                                              |   |
|           | Development   of the NFT GAME API connection module for UNITY 3D                                                                                                                                   | 14                                                                                                                                                                                                                                                                                                              |   |
|           | Development   of the NFT GAME API module for Unreal engine                                                                                                                                         | 14                                                                                                                                                                                                                                                                                                              |   |
|           | Linking   the NFT GAME API and modules for the Unity 3D and Unreal engine                                                                                                                          | 5                                                                                                                                                                                                                                                                                                               |   |
|           | Testing   the operation of the NFT GAME API and modules for game engines                                                                                                                           | 4                                                                                                                                                                                                                                                                                                               |   |
|           | Result                                                                                                                                                                                             | Ready   modules for the UNITY 3D and Unreal engine game engines that developers can   use to interact with the NFT GAME API. Documentation describing how to work   with NFT GAME API plug-ins for Unity 3D and Unreal Engine game engines.                                                                     |   |
| 4         | Development   of a DEMO game using the NFT GAME API                                                                                                                                                | 21                                                                                                                                                                                                                                                                                                              |   |
|           | NFT GAME   API connection                                                                                                                                                                          | 3                                                                                                                                                                                                                                                                                                               |   |
|           | Connecting   the Unity 3D module                                                                                                                                                                   | 4                                                                                                                                                                                                                                                                                                               |   |
|           | Testing   the game, writing documentation and an example of using the developed   solution                                                                                                         | 7                                                                                                                                                                                                                                                                                                               |   |
